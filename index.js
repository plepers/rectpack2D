...
rect_ltrb.prototype = {
  ...
  to_rect_xywh : function(){
    var r = new rect_xywh( this.l, this.t );
    r.setR(this.r);
    r.setB(this.b);
    return r;
  }
...
rect_xywhf.prototype.clone = function(){
  var res = new rect_xywhf(this.x, this.y, this.w, this.h)
...
node.prototype = {
  ...
  insert : function(rect_xywhf){
    ...
    if(this.c0.pn != null && this.c0.fill) {
      var newn = this.c0.pn.insert(rect_xywhf);
      if( newn != null ) return newn;
      return    this.c1.pn.insert(rect_xywhf);
    }

    if(this.id) return null;
    var f = rect_xywhf.fits( this.rc.to_rect_xywh() );
    ...
    var iw = 0|(rect_xywhf.flipped ? rect_xywhf.h : rect_xywhf.w), 
...
var discard_step = 128;



function _rect2D( v /*rect_xywhf*/, max_s, succ, unsucc ){
  
  var root = new node( new rect_ltrb(0, 0, 0, 0) );

  var n     = v.length;
  var funcs = cmpf.length;
  ...
  var min_bin = new rect_wh(max_s, max_s);
  var min_func = -1, best_func = 0, best_area = 0, _area = 0, step, fit, i;
...
function pack( v /*rect_xywhf*/, max_s, bins )
{
  ...
  var n     = v.length;
  var _rect = new rect_wh(max_s, max_s);
